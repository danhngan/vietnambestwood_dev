let slide_data = [
  ...
  //   autoplay;
  // });
  jQuery('#down_button').on('click',function(e){
      e.preventDefault();
      clearInterval(autoplay);
      nextSlide();
      autoplay;
    });
  jQuery('#up_button').on('click',function(e){
      e.preventDefault();
      clearInterval(autoplay);
      prevSlide();
      autoplay;
  ...
  function prevSlide(){
    ...
    slides[last].classList.add('previous','change');
...
// captions
    ...
    captions[last].classList.add('previous-caption','change');
